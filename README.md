...
```
3. `nodevfee` komutunu çalıştırın. Bu sefer `ctrl + c` ile çıkış yapın. Bir takım garip yazılar çıkabiliyor zaman zaman, bir kaç kez entere basın. Zaman zamanda komut satırına geri dönmüyor. HiveOS u reboot edin.
